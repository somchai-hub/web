    ...
    <section class="container mx-auto px-6 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
                ...
                <p class="mb-6">
                    หากคุณต้องการโปรโมทสถานที่ท่องเที่ยว ร้านอาหาร
                    หรือต้องการข้อมูลเพิ่มเติมเกี่ยวกับการเดินทางในอำเภอฝางและแม่อาย
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="flex items-center justify-end">
                        <button class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline transition" type="button">ส่งข้อความ</button>
                    </div>
                </form>
            </div>
        </div>
